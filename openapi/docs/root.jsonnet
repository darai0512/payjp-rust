...
local json = std.manifestJsonMinified(std.mergePatch(base, {
  ...
  components: {
      ...
      std.mergePatch(customer.components.schemas, {
        customer: {
          "x-operations": [
            ...
            f.Custom("/customers/{customer}/cards", "get", "list_card", "list"),
            f.Custom("/customers/{customer}/cards", "post", "create_card", "create"),
            f.Custom("/customers/{customer}/cards/{card}", "get", "retrieve_card", "retrieve"),
            f.Custom("/customers/{customer}/cards/{card}", "post", "update_card", "update"),
            f.Custom("/customers/{customer}/cards/{card}", "delete", "delete_card", "delete"),
    ...
    parameters: account.components.parameters +
        balance.components.parameters +
        charge.components.parameters +
        customer.components.parameters +
        event.components.parameters +
        plan.components.parameters +
        statement.components.parameters +
        subscription.components.parameters +
        tdsr.components.parameters +
        tenant.components.parameters +
        term.components.parameters +
