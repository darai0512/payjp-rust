...
impl RequestSpec {
    ...
    pub fn gen(&self, components: &Components) -> String {
        ...
        let _ = writedoc!(
            ...
            impl PayjpRequest for {impl_for_str} {{
    ...
    fn write_build_inner(&self) -> String {
        ...
        let _ = write!(build_inner, "RequestBuilder::new(PayjpMethod::{method_enum}, {path_arg})");
    ...
    fn gen_paginate(&self, pagination_typ: PrintableType, out: &mut String) {
        ...
        let _ = writedoc!(
            out,
            r#"
        pub fn paginate(&self) -> payjp_client_core::ListPaginator<{pagination_typ}> {{
            {build_inner}
            payjp_client_core::ListPaginator::new_list({path}, &self.inner)
        }}
        "#
        );
    }
